 ...
 */
public class AuthorWrapperMapper implements RowMapper<AuthorWrapper> {
    @Override
    public AuthorWrapper mapRow(ResultSet rs, int rowNum) throws SQLException {
        AuthorWrapper authorWrapper = new AuthorWrapper();
        List<Author> authorList = authorWrapper.getList();
        Author author = null;
        long id = 0L;
        do {
